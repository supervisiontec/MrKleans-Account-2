 ...
 */
package com.mac.care_point.transaction.return_cheque.model;
 ...
 */
public class ReturnChequeMix {
    private TAccLedger data;
    private List<TAccLedger> dataList;

    public ReturnChequeMix() {
    }

    public ReturnChequeMix(TAccLedger data, List<TAccLedger> dataList) {
        this.data = data;
