...
import com.mac.care_point.service.stock.JobItemStockRepository;
...
public class JobItemService {
    ...
    public List<Object[]> getNonPackageItem(String itemKey) {
        return jobItemRepository.getNonPackageItem(itemKey);
    }
    ...
    public TJobItem checkItem(Integer item, Integer branch, Integer jobCard, String status) {
        ...
        if ("COMPLITED".equals(status)) {
            ...
            stockLedger.setForm(Constant.FORM_STOCK);
