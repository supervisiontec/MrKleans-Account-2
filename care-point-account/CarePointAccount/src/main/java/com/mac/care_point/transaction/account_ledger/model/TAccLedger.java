...
public class TAccLedger implements Serializable {
    ...
    public TAccLedger(Integer indexNo, String transactionDate, Integer number, String currentDate, String time, int branch, int currentBranch, int user, BigDecimal debit, BigDecimal credit, String formName, Integer refNumber, String type, Integer typeIndexNo, String description, Integer accAccount) {
