    ...
    angular.module("appModule")
            .factory("itemSalesModel", function (itemSalesService, itemSalesFactory, $filter, $q, Notification) {
                ...
                paymentVoucherModel.prototype = {
                    ...
                    getNonPackageItemItem: function (itemKey) {
                        var that = this;
                        var defer = $q.defer();
                        itemSalesService.getNonPackageItemItem(itemKey)
                                .success(function (data) {
...
//                        this.payment.cashAmount = parseFloat(this.getTotalPaymentTypeWise('CASH'));
                    ...
                    clientLabelFormater: function (indexNo) {
                        ...
                        angular.forEach(this.clientList, function (client) {
                            if (client.indexNo === parseInt(indexNo)) {
                                data = client.indexNo + " - " + client.name + ' - ' + client.mobile;
                                return;
                            }
                        });
                        return data;
                    ...
                    findByBranchList: function (bank) {
                        ...
                        itemSalesService.registerCustomer(JSON.stringify(this.popupCustomer))
                                .success(function (data) {
                    ...
                    cardReaderLable: function (indexNo) {
                        ...
                        angular.forEach(this.cardReaderList, function (card) {
                            if (card.indexNo === parseInt(indexNo)) {
                                data = card.indexNo + ' - ' + card.name;
                                return;
                            }
                        });
                        return data;
