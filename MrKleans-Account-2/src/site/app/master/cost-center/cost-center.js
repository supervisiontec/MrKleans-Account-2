(function () {
    //module
    angular.module("costCenterModule", ['ui.bootstrap', 'ui-notification']);

    //http factory
    angular.module("costCenterModule")
            .factory("costCenterFactory", function ($http, systemConfig) {
                var factory = {};

                factory.loadData = function (callback) {
                    var url = systemConfig.apiUrl + "/api/care-point/master/cost-center";
                ...
                factory.save = function (summary, callback, errorCallback) {
                    var url = systemConfig.apiUrl + "/api/care-point/master/cost-center/save";
    ...
    //controller
    angular.module("costCenterModule")
            .controller("costCenterController", function ($scope, $rootScope, $filter, $log, ConfirmPane, $routeParams, costCenterFactory, Notification, $timeout) {
                //data models 
                $scope.model = {};
...
//                                    $scope.model.dataList.splice($scope.model.customerPlace(data.indexNo), 1);
                ...
                $scope.http.delete = function (indexNo, index) {
                    ...
                    if (check) {
                        ConfirmPane.dangerConfirm("do you want to delete !")
                                .confirm(function () {
                                    costCenterFactory.deleteFactory(indexNo
                                            , function () {
                ...
                $scope.ui.init = function () {
                    ...
                    costCenterFactory.loadData(function (data) {
                        $scope.model.dataList = data;
                    });
                    costCenterFactory.getPermission('Cost Center', function (data) {
