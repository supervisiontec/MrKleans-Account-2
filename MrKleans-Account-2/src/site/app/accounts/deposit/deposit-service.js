(function () {
    var service = function ($http, systemConfig) {
        ...
        this.loadAccAccountsAll = function () {
        ...
        this.saveFundTransfer = function (data) {
            return $http.post(systemConfig.apiUrl + "/api/care-point/transaction/deposit/save", data);
        };
        ...
        this.findFundTransferByNumberAndBranch = function (number) {
            return $http.get(systemConfig.apiUrl + "/api/care-point/transaction/deposit/find-fund-transfer-by-number-and-branch/" + number);
        };
