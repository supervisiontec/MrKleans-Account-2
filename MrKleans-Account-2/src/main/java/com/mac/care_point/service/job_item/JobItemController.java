...
public class JobItemController {
    ...
    @RequestMapping(value = "/get-non-package-item/{itemKey}", method = RequestMethod.GET)
    public List<Object[]> getNonPackageItem(@PathVariable String itemKey) {
        return jobItemService.getNonPackageItem(itemKey);
    }
