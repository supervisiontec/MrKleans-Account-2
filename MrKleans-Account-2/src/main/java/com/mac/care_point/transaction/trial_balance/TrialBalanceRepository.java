...
public interface TrialBalanceRepository extends JpaRepository<TAccLedger, Integer> {
    ...
    @Query(value = "CALL `p_get_trial_balance`(:date)", nativeQuery = true)
...
//    public List<Object[]> loadMainAcc(@Param("date") String date);
    ...
    @Query(value = "CALL p_get_trail_balance_sub(:date,:accNo)", nativeQuery = true)
    public List<Object[]> loadSubAccBalance(@Param("date") String date, @Param("accNo")Integer accNo);
